...
func TestBuild(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want: "-hide_banner -loglevel warning -nostdin -rtsp_transport tcp -analyzeduration 3000000 -probesize 2000000 -max_delay 500000 -err_detect ignore_err -fflags +genpts+discardcorrupt -i {input} -map 0:v:0? -map 0:a:0? -max_muxing_queue_size 4096 -c:v copy -c:a aac -b:a 192k -output_ts_offset 0 -f mpegts pipe:1",
		},
		{
		...
		},
		{
			...
			want: "-hide_banner -loglevel warning -nostdin -rtsp_transport tcp -analyzeduration 3000000 -probesize 2000000 -max_delay 500000 -err_detect ignore_err -fflags +genpts+discardcorrupt -i {input} -map 0:v:0? -map 0:a:0? -max_muxing_queue_size 4096 -c:v copy -c:a copy -output_ts_offset 0 -f mpegts pipe:1",
		},
		{
		...
		},
		{
			...
			want: "-hide_banner -loglevel warning -nostdin -err_detect ignore_err -fflags +genpts+discardcorrupt -i {input} -map 0:v:0? -map 0:a:0? -max_muxing_queue_size 4096 -c:v copy -c:a aac -b:a 192k -output_ts_offset 0 -f mpegts pipe:1",
		},
		{
			name: "QSV h264 RTSP",
		...
		},
		{
			...
			want: "-hide_banner -loglevel warning -nostdin -init_hw_device vaapi=va:/dev/dri/renderD128 -init_hw_device qsv=qs@va -hwaccel qsv -hwaccel_output_format qsv -rtsp_transport tcp -analyzeduration 3000000 -probesize 2000000 -max_delay 500000 -err_detect ignore_err -fflags +genpts+discardcorrupt -i {input} -map 0:v:0? -map 0:a:0? -max_muxing_queue_size 4096 -c:v hevc_qsv -preset veryslow -global_quality 22 -c:a aac -b:a 192k -output_ts_offset 0 -f mpegts pipe:1",
		},
		{
			...
			want: "-hide_banner -loglevel warning -nostdin -init_hw_device vaapi=va:/dev/dri/renderD128 -init_hw_device qsv=qs@va -hwaccel qsv -hwaccel_output_format qsv -rtsp_transport tcp -analyzeduration 3000000 -probesize 2000000 -max_delay 500000 -err_detect ignore_err -fflags +genpts+discardcorrupt -i {input} -map 0:v:0? -map 0:a:0? -max_muxing_queue_size 4096 -c:v av1_qsv -preset veryslow -global_quality 25 -c:a aac -b:a 192k -output_ts_offset 0 -f matroska pipe:1",
		},
		{
			name: "NVENC h264 RTSP",
			opts: BuildOptions{StreamURL: "rtsp://example.com/stream", HWAccel: "nvenc", VideoCodec: "h264", Container: "mpegts"},
			want: "-hide_banner -loglevel warning -nostdin -hwaccel cuda -hwaccel_output_format cuda -rtsp_transport tcp -analyzeduration 3000000 -probesize 2000000 -max_delay 500000 -err_detect ignore_err -fflags +genpts+discardcorrupt -i {input} -map 0:v:0? -map 0:a:0? -max_muxing_queue_size 4096 -c:v h264_nvenc -preset p4 -c:a aac -b:a 192k -output_ts_offset 0 -f mpegts pipe:1",
		},
		{
			name: "NVENC h265 RTSP",
			opts: BuildOptions{StreamURL: "rtsp://example.com/stream", HWAccel: "nvenc", VideoCodec: "h265", Container: "mpegts"},
			want: "-hide_banner -loglevel warning -nostdin -hwaccel cuda -hwaccel_output_format cuda -rtsp_transport tcp -analyzeduration 3000000 -probesize 2000000 -max_delay 500000 -err_detect ignore_err -fflags +genpts+discardcorrupt -i {input} -map 0:v:0? -map 0:a:0? -max_muxing_queue_size 4096 -c:v hevc_nvenc -preset p4 -c:a aac -b:a 192k -output_ts_offset 0 -f mpegts pipe:1",
		},
		{
		...
		},
		{
			...
			want: "-hide_banner -loglevel warning -nostdin -rtsp_transport tcp -analyzeduration 3000000 -probesize 2000000 -max_delay 500000 -err_detect ignore_err -fflags +genpts+discardcorrupt -i {input} -map 0:v:0? -map 0:a:0? -max_muxing_queue_size 4096 -c:v h264_videotoolbox -c:a aac -b:a 192k -output_ts_offset 0 -f mpegts pipe:1",
		},
		{
			...
			want: "-hide_banner -loglevel warning -nostdin -rtsp_transport tcp -analyzeduration 3000000 -probesize 2000000 -max_delay 500000 -err_detect ignore_err -fflags +genpts+discardcorrupt -i {input} -map 0:v:0? -map 0:a:0? -max_muxing_queue_size 4096 -c:v hevc_videotoolbox -c:a aac -b:a 192k -output_ts_offset 0 -f mpegts pipe:1",
		},
		{
		...
		},
		{
			...
			want: "-hide_banner -loglevel warning -nostdin -hwaccel cuda -hwaccel_output_format cuda -rtsp_transport tcp -analyzeduration 3000000 -probesize 2000000 -max_delay 500000 -err_detect ignore_err -fflags +genpts+discardcorrupt -i {input} -map 0:v:0? -map 0:a:0? -max_muxing_queue_size 4096 -vf yadif_cuda -c:v h264_nvenc -preset p4 -c:a copy -output_ts_offset 0 -f mpegts pipe:1",
		},
		{
