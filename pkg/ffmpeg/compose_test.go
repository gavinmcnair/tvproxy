...
func TestBuild(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want: "-hide_banner -loglevel warning -nostdin -analyzeduration 1000000 -probesize 1000000 -err_detect ignore_err -fflags +genpts+discardcorrupt -i {input} -map 0:v:0? -map 0:a:0? -max_muxing_queue_size 4096 -c:v copy -g 50 -keyint_min 50 -c:a aac -b:a 192k -output_ts_offset 0 -f mpegts pipe:1",
		},
		{
			...
			want: "-hide_banner -loglevel warning -nostdin -analyzeduration 1000000 -probesize 1000000 -err_detect ignore_err -fflags +genpts+discardcorrupt -i {input} -map 0:v:0? -map 0:a:0? -max_muxing_queue_size 4096 -c:v libx264 -preset fast -g 50 -keyint_min 50 -c:a aac -b:a 192k -output_ts_offset 0 -f mpegts pipe:1",
		},
		{
			...
			want: "-hide_banner -loglevel warning -nostdin -analyzeduration 1000000 -probesize 1000000 -err_detect ignore_err -fflags +genpts+discardcorrupt -i {input} -map 0:v:0? -map 0:a:0? -max_muxing_queue_size 4096 -c:v libx265 -preset fast -g 50 -keyint_min 50 -c:a aac -b:a 192k -output_ts_offset 0 -f mpegts pipe:1",
		},
		{
		...
		},
		{
			...
			want: "-hide_banner -loglevel warning -nostdin -analyzeduration 1000000 -probesize 1000000 -err_detect ignore_err -fflags +genpts+discardcorrupt -i {input} -map 0:v:0? -map 0:a:0? -max_muxing_queue_size 4096 -vf yadif -c:v libx264 -preset fast -g 50 -keyint_min 50 -c:a copy -output_ts_offset 0 -f mpegts pipe:1",
		},
		{
			...
			want: "-hide_banner -loglevel warning -nostdin -rtsp_transport tcp -analyzeduration 3000000 -probesize 2000000 -max_delay 500000 -err_detect ignore_err -fflags +genpts+discardcorrupt -i {input} -map 0:v:0? -map 0:a:0? -max_muxing_queue_size 4096 -c:v copy -g 50 -keyint_min 50 -c:a copy -output_ts_offset 0 -f mpegts pipe:1",
		},
		{
		...
		},
		{
			...
			want: "-hide_banner -loglevel warning -nostdin -analyzeduration 1000000 -probesize 1000000 -err_detect ignore_err -fflags +genpts+discardcorrupt -i {input} -map 0:v:0? -map 0:a:0? -max_muxing_queue_size 4096 -c:v libx264 -preset fast -g 50 -keyint_min 50 -c:a libopus -b:a 192k -output_ts_offset 0 -f webm pipe:1",
		},
		{
		...
		},
		{
			...
			want: "-hide_banner -loglevel warning -nostdin -analyzeduration 1000000 -probesize 1000000 -err_detect ignore_err -fflags +genpts+discardcorrupt -i {input} -map 0:v:0? -map 0:a:0? -max_muxing_queue_size 4096 -c:v copy -g 50 -keyint_min 50 -c:a aac -b:a 192k -output_ts_offset 0 -f matroska pipe:1",
		},
		{
			...
			want: "-hide_banner -loglevel warning -nostdin -analyzeduration 1000000 -probesize 1000000 -user_agent TestAgent/1.0 -err_detect ignore_err -fflags +genpts+discardcorrupt -i {input} -map 0:v:0? -map 0:a:0? -max_muxing_queue_size 4096 -c:v copy -g 50 -keyint_min 50 -c:a aac -b:a 192k -output_ts_offset 0 -f mpegts pipe:1",
		},
		{
			name: "no URL no transport flags",
			opts: BuildOptions{VideoCodec: "copy", Container: "mpegts"},
			want: "-hide_banner -loglevel warning -nostdin -err_detect ignore_err -fflags +genpts+discardcorrupt -i {input} -map 0:v:0? -map 0:a:0? -max_muxing_queue_size 4096 -c:v copy -g 50 -keyint_min 50 -c:a aac -b:a 192k -output_ts_offset 0 -f mpegts pipe:1",
		},
		{
			name: "QSV h264 RTSP",
