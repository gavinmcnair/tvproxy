(function() {
  ...
  const pages = {
    ...
    'source-profiles': buildCrudPage({
      ...
      columns: [
        { key: 'name', label: 'Name' },
        { key: 'source_type', label: 'Source Type', render: item => ({xtream:'Xtream Codes',m3u:'M3U Playlist',satip:'SAT>IP',local:'Local Server'})[item.source_type] || item.source_type },
        ...
        { key: 'interlaced', label: 'Interlaced', render: item => item.interlaced ? h('span', { className: 'badge badge-warning' }, 'Yes') : '' },
      ],
      fields: [
        ...
        { key: 'source_type', label: 'Source Type', type: 'select', options: [
          ...
          { value: 'local', label: 'Local Server (tvproxy-streams)' },
        ], default: 'xtream' },
        ...
        { key: 'video_codec', label: 'Expected Video Codec', type: 'select', options: [
          ...
          { value: 'av1', label: 'AV1' },
        ], default: 'h264', help: 'Expected codec from this source. Confirmed by probe on first play.' },
        ...
        ], default: 'aac', help: 'Expected audio codec. Determines if transcoding is needed for output.' },
        { key: 'container', label: 'Container Format', type: 'select', options: [
          ...
          { value: 'avi', label: 'AVI' },
        ], default: 'mpegts', help: 'Container format of the source stream.' },
        { key: 'interlaced', label: 'Interlaced', type: 'checkbox', default: false, help: 'Source delivers interlaced content (common for DVB/SAT>IP). Requires deinterlace filter when transcoding.' },
